...
class BiomedicalEquipmentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        BiomedicalEquipment::create(['name' => 'Silla de ruedas', 'description' => 'No registrada','maintenance_plan' => false,'risk_factor_id' => null ,'category_id' => 1]);
        ...
        BiomedicalEquipment::create(['name' => 'Tubos endotraqueales de diferentes calibres', 'description' => 'No registrada', 'maintenance_plan' => false, 'risk_factor_id' => null, 'category_id' => 2]);
        ...
        BiomedicalEquipment::create(['name' => 'Sistema de infusión rápida de líquidos', 'description' => 'No registrada', 'maintenance_plan' => true, 'risk_factor_id' => 3, 'category_id' => 2]);
        ...
        BiomedicalEquipment::create(['name' => 'Instrumental gineco-obstétrico', 'description' => 'No registrada', 'maintenance_plan' => false, 'risk_factor_id' => null, 'category_id' => 2]);
        BiomedicalEquipment::create(['name' => 'Equipo de atención de parto', 'description' => 'No registrada', 'maintenance_plan' => false, 'risk_factor_id' => null, 'category_id' => 2]);
        BiomedicalEquipment::create(['name' => 'Equipo de toracostomía', 'description' => 'No registrada', 'maintenance_plan' => false, 'risk_factor_id' => null, 'category_id' => 2]);
        BiomedicalEquipment::create(['name' => 'Equipo de pequeña cirugía', 'description' => 'No registrada', 'maintenance_plan' => false, 'risk_factor_id' => null, 'category_id' => 2]);
        BiomedicalEquipment::create(['name' => 'Equipo de punción lumbar', 'description' => 'No registrada', 'maintenance_plan' => false, 'risk_factor_id' => null, 'category_id' => 2]);
        ...
        BiomedicalEquipment::create(['name' => 'Equipo de rayos X portátil', 'description' => 'No registrada', 'maintenance_plan' => true, 'risk_factor_id' => 5, 'category_id' => 3]);
        ...
        BiomedicalEquipment::create(['name' => 'Sistema de calentamiento de líquidos y sangre', 'description' => 'No registrada', 'maintenance_plan' => false, 'risk_factor_id' => null, 'category_id' => 3]);
        BiomedicalEquipment::create(['name' => 'Laringoscopio con hojas curvas y rectas', 'description' => 'No registrada', 'maintenance_plan' => true, 'risk_factor_id' => 3, 'category_id' => 3]);
        ...
        BiomedicalEquipment::create(['name' => 'Glucómetro', 'description' => 'No registrada', 'maintenance_plan' => true, 'risk_factor_id' => null, 'category_id' => 3]);
        BiomedicalEquipment::create(['name' => 'Tensiómetro', 'description' => 'No registrada', 'maintenance_plan' => true, 'risk_factor_id' => null, 'category_id' => 3]);
        BiomedicalEquipment::create(['name' => 'Fonendoscopio', 'description' => 'No registrada', 'maintenance_plan' => true, 'risk_factor_id' => null, 'category_id' => 3]);
        BiomedicalEquipment::create(['name' => 'Equipo de órganos de los sentidos', 'description' => 'No registrada', 'maintenance_plan' => true, 'risk_factor_id' => null, 'category_id' => 3]);
        BiomedicalEquipment::create(['name' => 'Bomba de nutrición enteral', 'description' => 'No registrada', 'maintenance_plan' => true, 'risk_factor_id' => null, 'category_id' => 3]);
        BiomedicalEquipment::create(['name' => 'Oxímetro', 'description' => 'No registrada', 'maintenance_plan' => true, 'risk_factor_id' => null, 'category_id' => 3]);
        BiomedicalEquipment::create(['name' => 'Nebulizador', 'description' => 'No registrada', 'maintenance_plan' => true, 'risk_factor_id' => null, 'category_id' => 3]);
