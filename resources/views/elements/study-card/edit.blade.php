                    ...
                    <div class="col-lg-7 col-md-8">
                        <div class="tab-pane fade show active" id="list-0" role="tabpanel" aria-labelledby="list-0-list">
                            <div class="card shadow bg-white rounded">
                                ...
                                <div class="card-body">
                                    <form method="POST"
                                        action="{{ route('studyCards.update', $studyCard->id) }}"enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <input id="title" type="text"
                                                    ...
                                                    value="{{ old('title', $studyCard->title) }}" placeholder="Titulo" 
                                                    required autofocus />
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <input id="summary" type="text"
                                                    ...
                                                    value="{{ old('title', $studyCard->summary) }}" placeholder="Resumen"
                                                    required autofocus />
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control @error('content') is-invalid @enderror"
                                                    ...
                                                    required>{{ old('title', $studyCard->content) }}</textarea>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <div class="mt-3 img-preview text-center justify-content-center">
                                                    <img src="{{$studyCard->image}}" width="300px" id="preview" class="img-thumbnail">
                                                </div>
                                            </div>
                                        </div>
