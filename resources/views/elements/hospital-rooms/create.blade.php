...
@section('content')
    <main class="container-fluid">
        ...
        <div class="my-3">
            ...
            <h3 class="d-inline align-middle">Crear ambiente hospitalario</h3>
            <hr />
                    ...
                    <div class="col-lg-7 col-md-8">
                        <div class="tab-pane fade show active" id="list-0" role="tabpanel" aria-labelledby="list-0-list">
                            <div class="card shadow bg-white rounded">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('hospital-rooms.store') }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <input id="name" type="text"
                                                    ...
                                                    value="{{ old('name') }}" placeholder="Nombre" autocomplete="Nombre"
                                                    required autofocus />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select id="celling_id"
                                                    ...
                                                    name="celling_id" required>
                                                    @foreach ($cellings as $celling)
                                                        <option value="{{ $celling->id }}">
                                                            {{ $celling->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
