...
@section('content')
    <main class="container-fluid">
        ...
        <div class="my-3">
            ...
            <h3 class="d-inline align-middle">Ver techo</h3>
            <hr />
                            ...
                            <div class="card shadow bg-white rounded">
                                ...
                                <div class="card-body">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text ml-2 mb-3">{{ $celling->name }}</p>
                                        <h6 class="card-subtitle font-weight-bold">Descripción</h6>
                                        <p class="card-text ml-2 mb-3">{{ $celling->description }}</p>
                                        <div class="col-md-12">
                                            <a href="{{route('celling.index')}}" class="btn btn-primary btn-block">
