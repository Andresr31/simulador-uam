...
@section('content')
    <main class="container-fluid">
        ...
        <div class="my-3">
            ...
            <h3 class="d-inline align-middle">Editar pared</h3>
            <hr />
                    ...
                    <div class="col-lg-7 col-md-8">
                        <div class="tab-pane fade show active" id="list-0" role="tabpanel" aria-labelledby="list-0-list">
                            <div class="card shadow bg-white rounded">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('walls.update', $wall) }}"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <input id="name" type="text"
                                                    ...
                                                    value="{{ old('name', $wall->name) }}" placeholder="Nombre"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror"
                                                    ...
                                                    required>{{ old('description', $wall->description) }}</textarea>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <div class="mt-3 img-preview">
                                                    <img src="{{ $wall->image }}" id="preview" class="img-thumbnail">
                                                </div>
                                            </div>
                                        </div>
