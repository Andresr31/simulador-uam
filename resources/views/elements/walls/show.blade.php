...
@section('content')
    <main class="container-fluid">
        ...
        <div class="my-3">
            ...
            <h3 class="d-inline align-middle">Ver pared</h3>
            <hr />
                    ...
                    <div class="col-lg-7 col-md-8">
                        <div class="tab-pane fade show active" id="list-0" role="tabpanel" aria-labelledby="list-0-list">
                            <div class="card shadow bg-white rounded">
                                <div class="card-header text-center"> <h5>Información del elemento</h5></div>
                                <div class="card-body">
                                    <div class="card-body">
                                        <h6 class="card-subtitle font-weight-bold">Nombre</h6>
                                        <p class="card-text ml-2 mb-3">{{ $wall->name }}</p>
                                        <h6 class="card-subtitle font-weight-bold">Descripción</h6>
                                        <p class="card-text ml-2 mb-3">{{ $wall->description }}</p>

                                        <div class="form-group row">
                                            <div class="col-12">
                                                <div class="mt-3 img-preview justify-content-center">
                                                    <img src="{{ asset($wall->image) }}" id="preview"
                                                        class="img-thumbnail">
                                                </div>
                                            </div>
                                        </div>
