...
@section('content')
    <main class="container-fluid">
        ...
        <div class="my-3">
            ...
            <h3 class="d-inline align-middle">Editar usuario</h3>
            <hr />
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6">
                                                ...
                                                <input id="fullname" type="text"
                                                    ...
                                                    placeholder="Nombre completo" autocomplete="fullname" required
                                                    autofocus />
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                ...
                                                <select id="role" class="form-control @error('role') is-invalid @enderror"
                                                    name="role" required value="{{ old('role', $user->roles[0]->id) }}">
                                        ...
                                        <div class="form-student form-group row case-student">
                                            <div class="col-md-6">
                                                ...
                                                <select id="career_id"
                                                    ...
                                                    name="career_id" value="{{ old('career_id', $user->career_id) }}"
                                                    required>
                                                    @foreach ($careers as $career)
                                                        <option {{ $user->career_id == $career->id ? 'selected' : '' }}
                                                            value="{{ $career->id }}">
                                                            {{ $career->name }}
                                                        </option>
                                                    @endforeach
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select id="semester"
                                                    ...
                                                    name="semester" value="{{ old('semester', $user->semester) }}"
                                                    required>
                                                    @for ($i = 1; $i <= 10; $i++)
                                                        <option {{ $user->semester == $i ? 'selected' : '' }}
                                                            value="{{ $i }}">
                                                            {{ $i }}
                                                        </option>
                                                    @endfor
